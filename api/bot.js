  ...
  if (interaction.type === InteractionType.APPLICATION_COMMAND) {
    ...
    if (name === "roll") {
      ...
      return res.send({
        ...
        data: {
          content: `🎲 **${interaction.member?.user.username || "You"}** rolled a **${roll}**!`,
        },
      });
    }
    ...
    if (!charId) {
      return res.send({
        type: InteractionResponseType.CHANNEL_MESSAGE_WITH_SOURCE,
        data: {
          content: "❌ Your Discord ID isn't mapped to a character yet.",
        },
      });
    }
    ...
    const handleRoll = (label, jsonKey) => {
      ...
      const shouldRoll =
        options && options.find((o) => o.name === "roll" && o.value === true);
    ...
    if (name === "hp") {
      return res.send({
        type: InteractionResponseType.CHANNEL_MESSAGE_WITH_SOURCE,
        data: {
          content: `❤️ **${data.charName}** has **${data["hp-curr"]} / ${data["hp-max"]}** HP.`,
        },
      });
    }
    ...
    if (name === "str_check")
      return res.send({
        type: 4,
        data: handleRoll("Strength Check", "strength-mod"),
      });
    if (name === "dex_check")
      return res.send({
        type: 4,
        data: handleRoll("Dexterity Check", "dexterity-mod"),
      });
    if (name === "con_check")
      return res.send({
        type: 4,
        data: handleRoll("Constitution Check", "constitution-mod"),
      });
    if (name === "int_check")
      return res.send({
        type: 4,
        data: handleRoll("Intelligence Check", "intelligence-mod"),
      });
    if (name === "wis_check")
      return res.send({
        type: 4,
        data: handleRoll("Wisdom Check", "wisdom-mod"),
      });
    if (name === "cha_check")
      return res.send({
        type: 4,
        data: handleRoll("Charisma Check", "charisma-mod"),
      });
    ...
    if (name === "str_save")
      return res.send({
        type: 4,
        data: handleRoll("Strength Save", "save-val-strength"),
      });
    if (name === "dex_save")
      return res.send({
        type: 4,
        data: handleRoll("Dexterity Save", "save-val-dexterity"),
      });
    if (name === "con_save")
      return res.send({
        type: 4,
        data: handleRoll("Constitution Save", "save-val-constitution"),
      });
    if (name === "int_save")
      return res.send({
        type: 4,
        data: handleRoll("Intelligence Save", "save-val-intelligence"),
      });
    if (name === "wis_save")
      return res.send({
        type: 4,
        data: handleRoll("Wisdom Save", "save-val-wisdom"),
      });
    if (name === "cha_save")
      return res.send({
        type: 4,
        data: handleRoll("Charisma Save", "save-val-charisma"),
      });
    ...
    if (name === "athletics")
      return res.send({
        type: 4,
        data: handleRoll("Athletics", "val-strength-athletics"),
      });
    ...
    if (name === "acrobatics")
      return res.send({
        type: 4,
        data: handleRoll("Acrobatics", "val-dexterity-acrobatics"),
      });
    if (name === "sleight_of_hand")
      return res.send({
        type: 4,
        data: handleRoll("Sleight of Hand", "val-dexterity-sleight-of-hand"),
      });
    if (name === "stealth")
      return res.send({
        type: 4,
        data: handleRoll("Stealth", "val-dexterity-stealth"),
      });
    ...
    if (name === "arcana")
      return res.send({
        type: 4,
        data: handleRoll("Arcana", "val-intelligence-arcana"),
      });
    if (name === "history")
      return res.send({
        type: 4,
        data: handleRoll("History", "val-intelligence-history"),
      });
    if (name === "investigation")
      return res.send({
        type: 4,
        data: handleRoll("Investigation", "val-intelligence-investigation"),
      });
    if (name === "nature")
      return res.send({
        type: 4,
        data: handleRoll("Nature", "val-intelligence-nature"),
      });
    if (name === "religion")
      return res.send({
        type: 4,
        data: handleRoll("Religion", "val-intelligence-religion"),
      });
    ...
    if (name === "animal_handling")
      return res.send({
        type: 4,
        data: handleRoll("Animal Handling", "val-wisdom-animal-handling"),
      });
    if (name === "insight")
      return res.send({
        type: 4,
        data: handleRoll("Insight", "val-wisdom-insight"),
      });
    if (name === "medicine")
      return res.send({
        type: 4,
        data: handleRoll("Medicine", "val-wisdom-medicine"),
      });
    if (name === "perception")
      return res.send({
        type: 4,
        data: handleRoll("Perception", "val-wisdom-perception"),
      });
    if (name === "survival")
      return res.send({
        type: 4,
        data: handleRoll("Survival", "val-wisdom-survival"),
      });
    ...
    if (name === "deception")
      return res.send({
        type: 4,
        data: handleRoll("Deception", "val-charisma-deception"),
      });
    if (name === "intimidation")
      return res.send({
        type: 4,
        data: handleRoll("Intimidation", "val-charisma-intimidation"),
      });
    if (name === "performance")
      return res.send({
        type: 4,
        data: handleRoll("Performance", "val-charisma-performance"),
      });
    if (name === "persuasion")
      return res.send({
        type: 4,
        data: handleRoll("Persuasion", "val-charisma-persuasion"),
      });
  }
