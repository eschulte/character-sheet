...
- Clicking it doesn't necessarily need a full 3D dice engine, but it could trigger a "Spark" that says: _"Rolling for Stealth? Roll 1d20 and add 5!"_ This reinforces the core mechanic for beginners.
