...
function updatePrintInstructions() {
  ...
  instructions.innerText = `Print this page with ${isApple ? 'Command-P' : 'Control-P'}.`;
}
...
loadData().catch((error) => {
  console.error('Error loading print card data', error);
});
